...
while(flag==0):
    ...
    b=pwinput("Enter the password to conform\n")
    if a[2]==b:
        ...
        overtime="create table overtime (count int,month int,incriment double,OvertimeID varchar(12),foreign key(overtimeID) references emp_details(empID),primary key(OvertimeID,month),check(count>=0 or count=NULL),check(incriment>=0 or incriment=NULL),check(month>0 and month<=12));"
        ...
        command=['python',"C:\\Users\\Pruthviraj\\OneDrive\\Desktop\\final pj\\main.py"]
